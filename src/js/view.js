...
import { buildGlView } from "./views/glView";
...
const exhibitionsData = GetExhibitionsData();
...
// links
{
  meData.links.forEach((l) => {
    DOM.links.insertAdjacentHTML(
      "beforeend",
      MARKUP.link(l.link, l.icon, "color_icon p-0", "bottom")
    );
  });
}
    ...
    switch (pageName) {
      case "projects":
        mapPage.viewBuilder = function () {
          ...
          buildProjectView(mapPage, pages, Object.entries(projectData));
          mapPage.element.insertAdjacentHTML("beforeend", MARKUP.footerSpace());
        };
        break;
      case "resume":
      ...
      case "gallery":
        mapPage.viewBuilder = function () {
          ...
          // appending exhibitions information for gallery page
          imageData["exhibitions"] = exhibitionsData;

          buildGalleryView(mapPage, DOM.pageMenu, Object.entries(imageData));
          mapPage.element.insertAdjacentHTML("beforeend", MARKUP.footerSpace());
        };
        break;
      case "welcome":
      ...
      case "gl":
        mapPage.viewBuilder = function () {
          buildGlView(mapPage, DOM.pageMenu, meData);
          mapPage.element.insertAdjacentHTML("beforeend", MARKUP.footerSpace());
        };
        break;
      default:
