...
export const link = function (ref, link, o = "", dir = "right") {
...
export const image = function (src, o = "") {
  return `<img src="${
    src !== "" ? src : "src/img/misc/noImage.jpg"
  }" loading="lazy" class="${o}">`;
};
...
export const card = function (dom, name, data, o = "") {
  dom.insertAdjacentHTML(
    "beforeend",
    `<div class="row py-1 font_text game_widget_page ${o}"></div>`
  );
